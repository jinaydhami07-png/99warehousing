# Buy Per Square Foot — Platform Roadmap
...
| Feature scope | Vendor proposal's full module list | Mapped onto BPSF's warehouse/land domain in §5 |
...
| Module | Web | Mobile | Admin | Status | BPSF page(s) |
|---|:-:|:-:|:-:|---|---|
